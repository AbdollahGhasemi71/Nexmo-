                            ...
                            <td>
                                ...
                                <a href=""
                                   onclick="updateConfirmationStatus
                                       (event,'{{route('courses.accept',$course->id)}}','ایااز تایید این آیتم اطمینان دارید؟','تایید شده')"
                                   class="item-confirm mlg-15"
                                   title="تایید"></a>
                                <a href=""
                                   onclick="updateConfirmationStatus
                                       (event,'{{route('courses.reject',$course->id)}}','ایااز رد شده این آیتم اطمینان دارید؟','رد شده')"
                                   class="item-reject mlg-15"
                                   title="رد شده">
                                </a>
                                <a href=""
                                   onclick="updateConfirmationStatus
                                       (event,'{{route('courses.lock',$course->id)}}','ایااز  قفل شدن این آیتم اطمینان دارید؟',' قفل شده','status')"
